          	...
          	<div class="row mt">
                ...
                <div class="row mt">
                  ...
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Modificar Párrafos</h4>
                      <form action="<?php $_SERVER["PHP_SELF"]?>" class="form-horizontal style-form"  method="POST">
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                              <input type="text"class="form-control"name="parrafo" value="<?php echo $fila['parrafo']; ?>" required>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">NO.párrafo</label>
                              <div class="col-sm-4">
                                  <input type="text" name="no_parrafo" class="form-control" value="<?php echo $fila['no_parrafo']; ?>"required>
                              </div>
                          </div>
