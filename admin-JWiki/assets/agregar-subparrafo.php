      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i>Agrega información a un subtema de tu preferencia </h3>
              <div class="row mt">
          		<div class="col-lg-12">
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i>Ingresar subparrafo</h4>
                      <form class="form-horizontal style-form" method="post">
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Ingrese el numero de subparrafo (su posición en el tema seleccionado), tome en cuenta que 1 es el primero, dos el segundo...</label>
                              <div class="col-sm-1">
