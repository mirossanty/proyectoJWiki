...
<html lang="en">
  ...
  <section id="container" >
                  ...
                  <div class="form-panel">
                      ...
                      <form action="<?php $_SERVER["PHP_SELF"]?>" class="form-horizontal style-form"  method="post">
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                  <input type="text" name="nombreR" class="form-control" value="<?php echo $row['nombreR']; ?>"required>
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                  <input type="text" name="profesion" class="form-control"value="<?php echo $row['profesion']; ?>" required>
                              </div>
                          </div>
                          <div class="form-group">
    ...
    <button type="submit" name="editar" class="btn btn-theme">Actualizar</button>
